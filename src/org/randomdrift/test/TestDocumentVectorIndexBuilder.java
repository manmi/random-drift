...
public class TestDocumentVectorIndexBuilder {
	...
	public static void main(String[] args) throws CorruptIndexException, IOException{
		...
		endTime = System.currentTimeMillis();
		System.out.println("Time taken to build complete doc vectors: " + ((endTime - startTime) / 1000) + " seconds.");
...
//			};
		...
		String[] docToClassify  = {"out\\19288983.txt",
			"out\\19289044.txt",
			"out\\19289051.txt",
			"out\\19289084.txt",
			"out\\19289100.txt",
...
//				float simScore = docIndexBuilder.compareDocuments(docToClassifyPath, classes[j]);
...
//		}
		...
		for(int i = 0; i < docToClassify.length; i++){
			...
			System.out.println(docToClassifyPath + ", " + top1Class + ", "+ top2Class + ", " + top3Class + ", " + top4Class + ", " + top5Class);
		}
		
//		for(int k = 0; k < classes.length; k++){
//			System.out.println(classes[k] + " | " +docIndexBuilder.getDocRandomVector(classes[k]).toString());
//		}
	}
